...
### 2.1. При помощи [Terraform](https://github.com/sash3939/Diplom/tree/main/2Part) 3 виртуальные машины в Yandex Managed Kubernetes Cluster для создания Kubernetes-кластера: 1 Cluster и 3 Worker-node. Также создадим сервисные аккаунты и назначим им роли. Создадим бакет и сетевую инфраструктуру для Кубернетес
<details>
	<summary></summary>
      <br>
